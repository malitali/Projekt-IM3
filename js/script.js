...
// // Function to normalize strings to match flagMap keys
// function normalizeString(str) {
//     return str.trim().toLowerCase().replace(/[^a-z ]/g, ""); // Convert to lowercase, remove punctuation
// }
...
//         container.className = `podium-container podium-${index + 1}`;  // Assign podium-1, podium-2, podium-3 classes dynamically
...
function displayResults(data) {
    ...
    const flagMap = {
        ...
        "nigeria": "3944449_nigeria_national_world.png",
        "swaziland": "3944450_swaziland_national_world.png",
        "congo dr": "3944451_the_republic_democratic_national_worldgo_con_of.png", // Changed to "Congo DR" for consistency
        "united kingdom": "3944452_united_national_world_kingdom.png",
        "zambia": "3944453_zambia_national_world.png",
        "philippines": "3944454_philippines_national_world.png",
        "ivory coast": "3944455_coast_national_ivory_world.png", // Also known as "Côte d'Ivoire"
        "russia": "3944456_russia_national_world.png",
        "niger": "3944457_niger_national_world.png",
        "somalia": "3944458_somalia_national_world.png",
        "slovakia": "3944459_slovakia_national_world.png",
